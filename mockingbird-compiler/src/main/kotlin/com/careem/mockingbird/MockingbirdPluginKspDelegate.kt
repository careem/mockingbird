        ...
        target.afterEvaluate {
            if (hasKspPlugin(this)) {
                ...
                target.extensions.configure(KotlinMultiplatformExtension::class.java) {
                    ...
                    target.dependencies {
                        "ksp${selectedTargetName.capitalized()}Test"("com.careem.mockingbird:mockingbird-processor:${pluginExtensions.kspProcessorVersion}") // TODO better if I find a way to force the same plugin version
                    }
                    tasks.forEach { task ->
